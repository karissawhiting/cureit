...
The `cureit()` function is a wrapper for `smcure::smcure()`. Here we include ulceration status, sex and tumor thickness as variables of interest in both cure and survival portions. 
